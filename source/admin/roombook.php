							...
							<div class="panel-footer">
								<div class="row">
									...
									<div class="col-sm-6 text-right">
										<form method="post">
											<div class="form-group">
												<input type="hidden" name="DeleteRoom" value="Delete" class="btn btn-danger">
											</div>
...
if (isset($_POST['Delete'])) {
	...
	if ($st == "Delete") {
	//	echo "<script type='text/javascript'> window.location='home.php'</script>";
		//echo "<script type='text/javascript'>  window.location.href='ConsumerCloseConnection.php' </script>";
		$urb = "DELETE FROM  `roombook` WHERE id = '$id'";

		if (mysqli_query($con, $urb)) {
			echo "<script type='text/javascript'> alert('Room booking Deleted')</script>";
			echo "<script type='text/javascript'> window.location='home.php'</script>";
		}
	}
}
