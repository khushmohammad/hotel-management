...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>HARSVARDHAN HOTEL,</p>
				<p>Shastri nagar gulabpura Bhilwara,<br>Rajasthan,<br>India.</p>
				<p>(+94) 65 222 44 55</p>
			</address>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@HARSVARDHAN.com || Web :- www.HARSVARDHAN.com || Phone :- +94 65 222 44 55 </p>
			</div>
		</aside>
	</body>
</html>
