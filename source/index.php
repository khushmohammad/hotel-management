...
<body>
	...
	<div class="banner-top">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@HARSVARDHAN.com">INFO@HARSVARDHAN.COM</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+91 6378878511">+91 6378 878 511</a></li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HARS <span>VARDHAN</span>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HARSVARDHAN</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">About Our HARSVARDHAN</h3>
				...
				<div class="col-lg-12 p-3" style="padding: 10px;">					
					<p class="contact-agile1 p-3" style="padding: 10px;"><strong>Phone :</strong><a href="tel:+91 6378878511">+91 6378 878 511</a></p>
					<p class="contact-agile1 p-3" style="padding: 10px;"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@HARSVARDHAN.COM</a></p>
					<p class="contact-agile1 p-3" style="padding: 10px;"><strong>Address :</strong> Shastri nagar gulabpura Bhilwara (raj), India</p>
				</div>
		...
		<div class="container">
			...
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li>
						<img src="images/teams1.png" alt=" " class="img-responsive" />
					</li>
					<li>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Phone :</strong><a href="tel:+91 6378878511">+91 6378 878 511</a></p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@HARSVARDHAN.COM</a></p>
				<p class="contact-agile1"><strong>Address :</strong> Shastri nagar gulabpura Bhilwara (raj), India</p>
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3588.90869103895!2d74.65722783847579!3d25.905372009932375!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39693eec28e5f387%3A0xa8211091f8b3c104!2sShastri%20Nagar%2C%20Gulabpura%2C%20Rajasthan%20311021!5e0!3m2!1sen!2sin!4v1645528174881!5m2!1sen!2sin"></iframe>
			</div>
			<div class="clearfix"></div>
		</div>
	</section>
	<!-- /contact -->
	<div class="copy">
		<p>© 2017 HARSVARDHAN . All Rights Reserved | Design by <a href="index.php">HARSVARDHAN</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
